...
var AjaxUtil = function (url, params, type, dataType){
	...
	if(params){
		var data = {};
		if(params.indexOf("=")!=-1){                           //  "menuNo=24,menuName,menuPrice"
			var parArr = params.split(","); 					// parArr[0]= "menuNo=24"; parArr[1]= "menuName"; parArr[2] ="menuPrice"
			var paramArr = parArr[0].split("=");
