...
<!-- 	<div class="container">
			...
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<form id="login-form" onsubmit="return checkForm(this)">
						<div>
							아이디<input type="text" class="form-control" name="uiId" placeholder="ID">
						</div>
						<div>
							비밀번호<input type="password" class="form-control" name="uiPwd" placeholder="Password">
						</div>
						<div>
							비밀번호확인<input type="password" class="form-control" name="uiPwd2" placeholder="CheckPassword"> <a style="color: red">*password는
								6자 이상으로 한다 특수문자,대소문자,숫자 1개이상</a>
						</div>
						<div>
							<button type="button" onclick="checkForm(form)" class="form-control btn btn-primary">변경</button>
						</div>
					</form>
				</div>
			</div>
	...
	<div class="wrap">
		...
		<form id="login-form" onsubmit="return checkForm(this)">
			...
			<button type="button" onclick="checkForm(form)">변경</button>
		</form>
	</div>
</section>
</body>
